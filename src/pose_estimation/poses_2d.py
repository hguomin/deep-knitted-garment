...
lib_path = osp.join(this_dir, '..', '..', 'libs', 'deep-high-resolution-net.pytorch', 'lib')
add_path(lib_path)
...
# update config
cfg_path = osp.join(lib_path, '..', 'demo/inference-config.yaml')
cfg.defrost()
cfg.merge_from_file(cfg_path)
if cfg.TEST.MODEL_FILE:
    cfg.TEST.MODEL_FILE = osp.join(lib_path, '..', cfg.TEST.MODEL_FILE)
cfg.freeze()
